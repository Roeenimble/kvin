...
{/* This prologue allows a CJS2 module's exports to be loaded with eval(readFileSync(filename)) */
    ...
    module.declare([], function (require, exports, module) {
        ...
        /**
         * Serialize an instance of Plugin, preserving all item required for restore
         */
        ...
        /**
         * Serialize an instance of MimeType, preserving all item required for restore
         */
        function prepare$MimeType(o) {
            let ret = {
                ctr: 'MimeType',
                ps: {},
                arg: ""
            ...
            ret.ps["__mimeTypes"] = [];
            for (let prop of ['suffixes', 'description', 'type'])
                if (prop in o)
                    ret.ps[prop] = o[prop];
            if ("enabledPlugin" in o && o.enabledPlugin !== null)
                ret.ps["__pluginName"] = o.enabledPlugin.name;
            return ret;
        }
        ...
        KVIN.prototype.prepare = function prepare(seen, o, where) {
            ...
            if (o instanceof MimeType || o instanceof this.standardObjects.MimeType) {
                /* special-case Error to get non-enumerable properties */
                return prepare$MimeType(o);
            }
